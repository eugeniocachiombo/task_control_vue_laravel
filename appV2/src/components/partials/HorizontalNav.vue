...
<template>
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
        <div class="text-center bg-dark text-white navbar-brand-wrapper d-flex align-items-center justify-content-start">
            <div class="me-3">
        ...
        <div class="navbar-menu-wrapper bg-dark text-white d-flex align-items-top">
            <ul class="navbar-nav">
                <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                    <h1 class="welcome-text fs-4">Bem-Vindo, <span class="text-black fw-bold ">{{userLogged?.name}}</span>
                    </h1>
                </li>
            </ul>
