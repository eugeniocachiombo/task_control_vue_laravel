...
<template>
    <nav style="background: #222; color: white; height: max-content;" class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
        <div style="background: #222; color: white;" class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
            <div class="me-3">
        ...
        <div style="background: #222; color: white;" class="navbar-menu-wrapper d-flex align-items-top">
            <ul class="navbar-nav text-white">
                <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                    <h1 class="welcome-text fs-4">Bem-Vindo, <span class="text-white fw-bold ">{{userLogged?.name}}</span>
                    </h1>
                </li>
            </ul>
