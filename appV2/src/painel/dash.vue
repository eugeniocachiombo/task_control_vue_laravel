            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text fs-4">Bem-Vindo, <span class="text-black fw-bold ">{{ userName }}</span>
                        </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div class="col-6">
                                        <p class="statistics-title">Em Execução</p>
                                        <h3 class="rate-percentage">32.53%</h3>
                                        <p class="text-danger d-flex"><i
                                                class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p>
                        ...
                        <div class="col-lg-4 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div class="col-6">
                                        <p class="statistics-title">Finalizados</p>
                                        <h3 class="rate-percentage">32.53%</h3>
                                        <p class="text-danger d-flex"><i
                                                class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p>
